...
• Add tasks, delete them, or mark them done
• Filter your list by All, Pending, or Completed
• Tasks save to a local tasks.json when you exit and reload next time you open it
